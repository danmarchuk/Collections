    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 0:
            ...
            guard let destinationVC = storydoard
                .instantiateViewController(withIdentifier: "ArrayStoryboard") as? ArrayViewController
            else {
                return
            }
        ...
        case 1:
            ...
            guard let destinationVC = storydoard
                .instantiateViewController(withIdentifier: "SetStoryboard") as? SetViewController
            else {
                return
            }
        ...
        case 2:
            ...
            guard let destinationVC = storydoard
                .instantiateViewController(withIdentifier: "DictionaryStoryboard") as? DictionaryViewController
            else {
                return
            }
